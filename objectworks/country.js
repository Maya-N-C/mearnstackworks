var indiadata=[
  ...
  //print capital
  let capitalname=indiadata[0].capital
//print population
let populationrate=indiadata[0].population
// console.log(indiadata[0].population);
//print borders
let borders=[...indiadata[0].borders]
// console.log(indiadata[0].borders);
//print cuurency nd symbol
let cuurencyname=indiadata[0].currencies[0].name
...
//print flag
//print language
let finaldata={countryname,capitalname,populationrate,borders,cuurencyname,symbol}
